...
<div class="bgded overlay" style="background-image:url('././public/images/demo/backgrounds/05.jpg');"> 
  <section id="breadcrumb" class="hoc clear"> 
    <h6 class="heading">Idée pour le monde</h6>
    <ul>
      <li><a href="index.php">Accueil</a></li>
      <li><a href="http://localhost/idee/index.php?action=listeworld">Liste world</a></li>
      <li><a href="index.php?id=<?= $_GET['id'] ?>&action=worldpost"><?= htmlspecialchars($post['title']) ?></a></li>
    </ul>
  </section>
</div>
          ...
          <li>
            <article>
              ...
              <div class="comcont">
                ...
                <a class="signaler" href="./index.php?action=signalWorldCo&amp;id=<?= $comment['id'] ?>">Signaler</a>
                <hr> 
