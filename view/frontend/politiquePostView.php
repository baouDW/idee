...
{lang: 'fr'}
              ...
              <div class="avis-item"><a href="./index.php?action=signalPolitique&amp;id=<?= $post['id'] ?>">signaler</a></div>
            </p>
          </div>
          <hr>
          <?php
          ...
          <div class="media mb-4">
            ...
            </div><a href="./index.php?action=signalPolitiqueCo&amp;id=<?= $comment['id'] ?>">Signaler</a>
          </div>
            <?php
            }
            ?>
