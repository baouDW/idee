...
<div class="col-md-12">
  <div class="card card-plain">
    <div class="card-header card-header-primary">
      <h4 class="card-title mt-0"> Publications</h4>
        ...
        <table class="table table-hover">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <a href="./index.php?action=upview&id=<?= $data['id'] ?>" class="edit"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                <a href="index.php?id=<?= $data['id'] ?>&action=suppr" class="delete"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
              </td>
            </tr>  
            <?php
            }
            ...
            <tr>
              ...
              <td>
                  <a href="./index.php?action=upentrepriseview&id=<?= $edata['id'] ?>" class="edit"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                  <a href="index.php?id=<?= $edata['id'] ?>&action=supprentreprise" class="delete"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
              </td>
            </tr>  
            <?php
            }
            ...
            <tr>
              ...
              <td>
                  <a href="./index.php?action=uppolitiqueview&id=<?= $pdata['id'] ?>"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
